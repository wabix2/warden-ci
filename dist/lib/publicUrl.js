...
exports.CANONICAL_BASE_URL = void 0;
...
function trustedPublicOrigin(value) {
    try {
        ...
        if (url.hostname !== "warden-ci-dvk5.onrender.com")
            return DEFAULT_PUBLIC_ORIGIN;
        return url.origin;
    }
    catch {
...
const CONFIGURED_PUBLIC_ORIGIN = (process.env.WARDEN_PUBLIC_URL || process.env.PUBLIC_BASE_URL || "")
    .trim()
    .replace(/\/$/, "");
exports.CANONICAL_BASE_URL = trustedPublicOrigin(CONFIGURED_PUBLIC_ORIGIN || DEFAULT_PUBLIC_ORIGIN);
